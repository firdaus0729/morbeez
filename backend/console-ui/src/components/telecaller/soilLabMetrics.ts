...
export function emptySoilForm(): { macro: Record<string, string>; micro: Record<string, string> } {
...
export function formToMetricsPayload(macro: Record<string, string>, micro: Record<string, string>) {
